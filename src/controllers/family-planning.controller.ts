...
import { familyPlanningCreateSchema } from "../validations/family-planning.validation";
  ...
  public createFamilyPlanning = catchAsync(
    async (req: AuthRequest, res: Response) => {
      ...
      if ("error" in result) {
        ...
        throw new AppError("Unable to create family planning", HTTP_STATUS.BAD_REQUEST);
      }
